...
// Substituted useRoute() by element of Inertia page or route
const page = usePage()
    ...
    <Component :is="props.tag" ref="refNav" class="layout-vertical-nav" :class="[
        ...
        <div class="nav-header">
            <slot name="nav-header">
                <Link :href="route('dashboard')" class="app-logo d-flex align-center gap-x-3 app-title-wrapper">
                ...
                <template v-if="!isLessThanOverlayNavBreakpoint(windowWidth)">
                    <Component :is="config.app.iconRenderer || 'div'" v-show="isCollapsed && !hideTitleAndIcon"
                        class="header-action" v-bind="config.icons.verticalNavUnPinned"
